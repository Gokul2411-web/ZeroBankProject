...
public class LoginStepDefinition {
	...
	public void user_should_be_redirected_to_the_account_summary_page()throws IOException {
		Assert.assertEquals(driver.getTitle(), "Zero - Personal Banking - Loans - Credit Cards");
		Utils.takeScreenshot(driver, "Login_Successful");
	}
	...
	public void user_should_see_an_error_message(String expectedMessage) throws InterruptedException, IOException {
		Thread.sleep(2000);
		Assert.assertEquals(loginPage.getErrorMessage(), expectedMessage);
		Utils.takeScreenshot(driver, "LoginWithInvalidCredentials");
	}
